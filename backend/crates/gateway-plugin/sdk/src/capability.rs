...
impl Capability {
    ...
    pub const fn fixed_stages(self) -> &'static [Stage] {
        match self {
            Self::Models | Self::Authentication | Self::Quota => {
            ...
            Self::Executor | Self::Billing => &[Stage::Execution],
            Self::Middleware => &[],
            ...
            Self::AccountManagement => &[Stage::Management, Stage::Observation],
            Self::RequestProfile | Self::Maintenance => &[Stage::Maintenance],
        }
    }
}
