...
impl CredentialsService {
    pub fn providers(
        &self,
    ) -> Result<Vec<crate::model::provider_capabilities::ProviderCredentialDescriptor>, AdminError>
    {
        self.providers
            .credential_descriptors()
            .map_err(|error| super::map_provider_error(error, "provider capabilities"))
    }
